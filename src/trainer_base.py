...
class TrainerBase(object):
    ...
    def save(self, name):
        if not os.path.isdir(self.args.output_path):
            os.makedirs(self.args.output_path, exist_ok=True)
        torch.save(self.model.state_dict(), os.path.join(self.args.output_path, "%s.pth" % name))
        torch.save(self.optim.state_dict(), os.path.join(self.args.output_path, "%s_opt.pth" % name))
